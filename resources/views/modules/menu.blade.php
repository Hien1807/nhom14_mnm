             ...
             <span  class="visible-xs pull-right" style="font-size:20px;cursor:pointer; padding-right: 10px; padding-top: 8px; color: #FFFFFF;" >      
              <!-- Authentication Links -->
                @if (Auth::guest())
                    ...
                    <a href="{{ url('/login') }}" data-toggle="modal" data-target="#login-modal" style="color:#e67e22;"> Đăng nhập </a>
          ...
          <div class="collapse navbar-collapse" id="main-mav-top">
            <ul class="nav navbar-nav">
             ...
             <ul class="nav navbar-nav pull-right">
              ...
              <li class="dropdown">
                <a href="{!!url('/gio-hang/')!!}" class="dropdown-toggle" data-toggle="dropdown"> <span class="glyphicon glyphicon-shopping-cart"><span class="badge">{!!Cart::count();!!}</span></span> Giỏ Hàng <b class="caret"></b></a>
              ...
              <!-- Authentication Links -->
                @if (Auth::guest())
                    <li><a href="login" data-toggle="modal" data-target="#login-modal">Đăng nhập</a></li>
                @else
                    <li class="dropdown">
