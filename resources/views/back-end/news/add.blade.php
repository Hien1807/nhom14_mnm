				      		...
				      		<div class="form-group">
				      			...
				      			<div class="row">					      			
					      			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					      				...
					      				<textarea name="txtIntro" id="inputTxttxtIntro" class="form-control" rows="2" required="required" style="height:200px">{{ old('txtIntro') }}</textarea>
...
{{--										</script>--}}
					      			...
					      			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					      				...
					      				<textarea name="txtFull" id="inputtxtFull" class="form-control" rows="4" required="required" style="height:200px">{{ old('txtFull') }}</textarea>
{{--					      				<script type="text/javascript">--}}
