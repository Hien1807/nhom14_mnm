				      		...
				      		<div class="form-group">
				      			...
				      			<div class="row">					      			
					      			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					      				...
					      				<textarea name="txtre_Intro" id="inputTxtre_Intro" class="form-control" style="height: 200px" value="{{ old('txtre_Intro') }}" rows="2" required="required"></textarea>
					      			</div>
					      			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					      				<label for="input-id">Bài đánh giá chi tiết</label>
					      				<textarea name="txtReview" id="inputtxtReview" class="form-control" style="height: 200px" rows="4" value="{{ old('txtReview') }}" required="required"></textarea>
